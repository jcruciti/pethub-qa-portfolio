...
|  ID | Action                                                          | Expected Result                                                                                                                   |
| --: | --------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------- |
|   1 | Select an available sorting option from the inventory dropdown. | The inventory items are reordered according to the selected sorting option, and the selected option remains displayed.            |
|   2 | Add one or more available pets to the cart.                     | The cart badge reflects the number of cart lines according to the app’s documented cart behavior.                                 |
|   3 | Open the cart.                                                  | The selected item list, line totals, and subtotal are displayed.                                                                  |
|   4 | Remove one item or update the quantity.                         | The cart count and subtotal update to match the current cart state.                                                               |
|   5 | Continue to checkout.                                           | The checkout form is presented with the expected required fields.                                                                 |
|   6 | Submit valid customer information.                              | The user advances to the confirmation page.                                                                                       |
|   7 | Review the confirmation.                                        | The confirmation page is displayed and the order creation flow proceeds according to the documented storefront checkout behavior. |
